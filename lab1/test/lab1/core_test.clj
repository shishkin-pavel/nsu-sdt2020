...
(deftest add-char-test
  (testing "add-char"
    (is (= (lab1.task1/add-char "" `()) `()))
    (is (= (lab1.task1/add-char "a" `()) `()))
    (is (= (lab1.task1/add-char "a" `("a")) `()))
    (is (= (lab1.task1/add-char "a" `("a" "b")) `("ab")))
    (is (= (lab1.task1/add-char "a" `("a" "b" "c")) `("ab" "ac")))))
...
(deftest concat-string-list-test
  (testing "concat-string-list"
    ...
    (is (= (lab1.task1/concat-string-list `("a" "b" "c") `("a" "b" "c")) `("ab" "ac" "ba" "bc" "ca" "cb")))
    (is (= (lab1.task1/concat-string-list `("a" "b" "c") `("ab" "ac" "ba" "bc" "ca" "cb")) `("aba" "abc" "aca" "acb" "bab" "bac" "bca" "bcb" "cab" "cac" "cba" "cbc")))))
...
(deftest add-char-recur-test
  (testing "add-char-recur"
    (is (= (lab1.task2/add-char-recur "" `()) `()))
    (is (= (lab1.task2/add-char-recur "a" `()) `()))
    (is (= (lab1.task2/add-char-recur "a" `("a")) `()))
    (is (= (lab1.task2/add-char-recur "a" `("a" "b")) `("ab")))
    (is (= (lab1.task2/add-char-recur "a" `("a" "b" "c")) `("ab" "ac")))))
...
(deftest concat-string-list-recur-test
  (testing "concat-string-list-recur"
    ...
    (is (= (lab1.task2/concat-string-list-recur `("a" "b" "c") `("a" "b" "c")) `("ab" "ac" "ba" "bc" "ca" "cb")))
    (is (= (lab1.task2/concat-string-list-recur `("a" "b" "c") `("ab" "ac" "ba" "bc" "ca" "cb")) `("aba" "abc" "aca" "acb" "bab" "bac" "bca" "bcb" "cab" "cac" "cba" "cbc")))))
...
(deftest add-char-map-test
  (testing "add-char"
    (is (= (lab1.task4/add-char-map "" `()) `()))
    (is (= (lab1.task4/add-char-map "a" `()) `()))
    (is (= (lab1.task4/add-char-map "a" `("a")) `()))
    (is (= (lab1.task4/add-char-map "a" `("a" "b")) `("ab")))
    (is (= (lab1.task4/add-char-map "a" `("a" "b" "c")) `("ab" "ac")))))
...
(deftest concat-string-list-map-test
  (testing "concat-string-list-map"
    ...
    (is (= (lab1.task4/concat-string-list-map `("a" "b" "c") `("a" "b" "c")) `("ab" "ac" "ba" "bc" "ca" "cb")))
    (is (= (lab1.task4/concat-string-list-map `("a" "b" "c") `("ab" "ac" "ba" "bc" "ca" "cb")) `("aba" "abc" "aca" "acb" "bab" "bac" "bca" "bcb" "cab" "cac" "cba" "cbc")))))
